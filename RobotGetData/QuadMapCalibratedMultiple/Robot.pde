...
void getRobotQuads() {
  ...
  //kks.setRobotCoordinates(q2A_TL,q2A_TR,q2A_BR,q2A_BL);
  
  
  kkss.get(0).setRobotCoordinates(qBA_TL,qBA_TR,qBA_BR,qBA_BL);
  kkss.get(1).setRobotCoordinates(q1A_TL,q1A_TR,q1A_BR,q1A_BL);
  kkss.get(2).setRobotCoordinates(q1B_TL,q1B_TR,q1B_BR,q1B_BL);
  
  kkss.get(3).setRobotCoordinates(q2A_TL,q2A_TR,q2A_BR,q2A_BL);
  kkss.get(4).setRobotCoordinates(q2B_TL,q2B_TR,q2B_BR,q2B_BL);
  kkss.get(5).setRobotCoordinates(q2C_TL,q2C_TR,q2C_BR,q2C_BL);
  
  kkss.get(6).setRobotCoordinates(q4A_TL,q4A_TR,q4A_BR,q4A_BL);
  kkss.get(7).setRobotCoordinates(q4B_TL,q4B_TR,q4B_BR,q4B_BL);
  kkss.get(8).setRobotCoordinates(q4C_TL,q4C_TR,q4C_BR,q4C_BL);
  
  //surfaces.get(0).setRobotCoordinates(q2A_TL,q2A_TR,q2A_BR,q2A_BL, false);
  
  /*
  println(q1A_TL,q1A_TR,q1A_BR,q1A_BL);
  
  surfaces.get(0).setRobotCoordinates(qBA_TL,qBA_TR,qBA_BR,qBA_BL, true);
  surfaces.get(1).setRobotCoordinates(q1A_TL,q1A_TR,q1A_BR,q1A_BL, true);
  surfaces.get(2).setRobotCoordinates(q1B_TL,q1B_TR,q1B_BR,q1B_BL, true);
  
  surfaces.get(3).setRobotCoordinates(q2A_TL,q2A_TR,q2A_BR,q2A_BL, true);
  surfaces.get(4).setRobotCoordinates(q2B_TL,q2B_TR,q2B_BR,q2B_BL, true);
  surfaces.get(5).setRobotCoordinates(q2C_TL,q2C_TR,q2C_BR,q2C_BL, true);
  
  surfaces.get(6).setRobotCoordinates(q4A_TL,q4A_TR,q4A_BR,q4A_BL, true);
  surfaces.get(7).setRobotCoordinates(q4B_TL,q4B_TR,q4B_BR,q4B_BL, true);
  surfaces.get(8).setRobotCoordinates(q4C_TL,q4C_TR,q4C_BR,q4C_BL, true);
  
  
  
  
  if (idxS == 0)      { TL= qBA_TL; TR = qBA_TR; BR = qBA_BR; BL = qBA_BL; }
  else if (idxS == 1) { TL= q1A_TL; TR = q1A_TR; BR = q1A_BR; BL = q1A_BL; }
  else if (idxS == 2) { TL= q1B_TL; TR = q1B_TR; BR = q1B_BR; BL = q1B_BL; }
  else if (idxS == 3) { TL= q2A_TL; TR = q2A_TR; BR = q2A_BR; BL = q2A_BL; }
  else if (idxS == 4) { TL= q2B_TL; TR = q2B_TR; BR = q2B_BR; BL = q2B_BL; }
  else if (idxS == 5) { TL= q2C_TL; TR = q2C_TR; BR = q2C_BR; BL = q2C_BL; }
  else if (idxS == 6) { TL= q4A_TL; TR = q4A_TR; BR = q4A_BR; BL = q4A_BL; }
  else if (idxS == 7) { TL= q4B_TL; TR = q4B_TR; BR = q4B_BR; BL = q4B_BL; }
  else if (idxS == 8) { TL= q4C_TL; TR = q4C_TR; BR = q4C_BR; BL = q4C_BL; }
