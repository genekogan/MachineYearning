...
void main( void ) {
	...
	float mz = 20.0*noise(vec3(p.x, 0.5*0.0, 1.5));
	p.y += 0.2*step(sin(mz*p.x + time), 0.25);
	p.y -= mod(p.y+0.01*time, dy);

	
	float z = noise(vec3(0.04*time, 123000000000.2*p.x/mx, 90.2*my*p.y));
